...
export default function HeroSection() {
  ...
  return (
    <Section
      ...
      innerClassName="grid grid-cols-1 md:grid-cols-12 pt-10 md:pt-10 items-stretch w-full mx-auto relative px-2 md:px-6 max-w-[1480px] gap-2 md:gap-20"
    >
      {/* Texto */}
      <div className="md:col-span-6 flex flex-col justify-center pt-6 ">
        ...
        <p className="mt-6 md:mt-20 text-[#FFFFFF]/70 text-lg sm:text-xl md:text-2xl font-sub">{subtitle}</p>
      ...
      <div className="md:col-span-6 flex md:justify-end md:items-center">
        <div className="relative w-full md:w-[min(60vw,860px)] lg:w-[min(56vw,980px)] ">
          <div className=" h-[38vh] sm:h-[64vh] md:h-[min(80vh,820px)] lg:h-[min(86vh,920px)]">
            <Image src={image.src} alt={image.alt} fill priority sizes="(max-width: 768px) 95vw, (max-width: 1200px) 60vw, 980px" className="object-contain " />
          </div>
        </div>
      </div>
    </Section>
